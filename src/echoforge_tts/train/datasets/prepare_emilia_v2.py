# put in src/echoforge_tts/train/datasets/prepare_emilia_v2.py
...
from echoforge_tts.model.utils import repetition_found
...
if __name__ == "__main__":
    ...
    save_dir = str(files("echoforge_tts").joinpath("../../")) + f"/data/{dataset_name}"
