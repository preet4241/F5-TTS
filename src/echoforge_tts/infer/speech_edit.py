...
model_cfg = OmegaConf.load(str(files("echoforge_tts").joinpath(f"configs/{exp_name}.yaml")))
...
# ctc-forced-aligner --audio_path "src/echoforge_tts/infer/examples/basic/basic_ref_en.wav" --text_path "tests/test_edit.txt" --language "zho" --romanize --split_size "char"
# [result will be saved at same path of audio file]
# [--language "zho" for Chinese, "eng" for English]
# [if local ckpt, set --alignment_model "../checkpoints/mms-300m-1130-forced-aligner"]

audio_to_edit = str(files("echoforge_tts").joinpath("infer/examples/basic/basic_ref_en.wav"))
...
# audio_to_edit = "src/echoforge_tts/infer/examples/basic/basic_ref_zh.wav"
