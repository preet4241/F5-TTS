...
from echoforge_tts.model.utils import default
...
def load_dataset(
    ...
    if dataset_type == "CustomDataset":
        rel_data_path = str(files("echoforge_tts").joinpath(f"../../data/{dataset_name}_{tokenizer}"))
        if audio_type == "raw":
            try:
        ...
        train_dataset = HFDataset(
            load_dataset(f"{pre}/{pre}", split=f"train.{post}", cache_dir=str(files("echoforge_tts").joinpath("../../data"))),
        )
