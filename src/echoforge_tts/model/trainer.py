...
from echoforge_tts.model.dataset import DynamicBatchSampler, collate_fn
from echoforge_tts.model.utils import default, exists
...
class Trainer:
    def __init__(
        ...
        self.checkpoint_path = default(checkpoint_path, "ckpts/test_echoforge")
    ...
    def train(self, train_dataset: Dataset, num_workers=16, resumable_with_seed: int = None):
        if self.log_samples:
            from echoforge_tts.infer.utils_infer import cfg_strength, load_vocoder, nfe_step, sway_sampling_coef
